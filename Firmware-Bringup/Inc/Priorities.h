...
#define SPI_INTERRUPT_PRIORITY		8
#define I2C_INTERRUPT_PRIORITY		9
#define TIMER_INTERRUPT_PRIORITY	10
#define IO_INTERRUPT_PRIORITY		11
#define SMBUS_INTERRUPT_PRIORITY	12
